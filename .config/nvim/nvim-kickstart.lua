...
-- automatic remove lead spaces
vim.api.nvim_create_autocmd('BufWritePre', {
  desc = 'Automatically remove lead spaces when saving buffer',
...
require('lazy').setup({
  ...
  { --vim-slime
    ...
    config = function ()
      vim.keymap.set({'n', 'i', 'x'}, '<m-cr>', "<Plug>SlimeRegionSend", { desc = 'send line to terminal'})
    end
  },
    ...
    keys = {
			{"<M-p>", "<Plug>yankstack_substitute_older_paste", desc = "Replace paste with older."},
			{"<M-p>", "<Plug>yankstack_substitute_newer_paste", desc = "Replace paste with newer."},
    },
	},
