...
M.run_code = function()
  ...
  local supported_filetypes = {
    ...
    cpp = {
      default = "g++ -Wall -Wextra -g3 % -o  $fileBase && ./$fileBase",
      debug = "g++ -Wall -Wextra -g3 % -o  $fileBase",
  ...
  if supported_filetypes[file_extension] then
    ...
    elseif #choices == 1 then
      ...
      vim.cmd(term_cmd .. M.substitute(selected_cmd) .. '; exit')
    else
...
vim.keymap.set("n", "<F6>", M.run_code, { desc = "Run code" })
